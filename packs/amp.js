...
const UIStrings = {
  ...
  'uses-webp-images': 'Consider displaying all your [`amp-img`](https://amp.dev/documentation/components/amp-img/?format=websites) components in WebP formats while specifying an appropriate fallback for other browsers. [Learn more](https://amp.dev/documentation/components/amp-img/#example:-specifying-a-fallback-image).',
  ...
  'offscreen-images': 'Ensure that you are you using valid [`amp-img`](https://amp.dev/documentation/components/amp-img/?format=websites) tags for your images which automatically lazy-load outside the first viewport. [Learn more](https://amp.dev/documentation/guides-and-tutorials/develop/media_iframes_3p/?format=websites#images).',
